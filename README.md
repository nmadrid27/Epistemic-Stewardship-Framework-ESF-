...
Universities have AI policies that regulate *whether* AI can be used. None have a method for *how* to use it without losing intellectual ownership of the work.
...
[Full setup instructions →](https://github.com/nmadrid27/esf-community-toolkit)
