...
```bash
curl -sSL https://raw.githubusercontent.com/YOUR-ORG/YOUR-FORK/main/community-toolkit/install.sh | bash
```
...
The SCAD Applied AI program's [student toolkit](../student-toolkit/) and [faculty toolkit](../faculty-toolkit/) are fully customized versions of this same framework. They add:
...
- Portfolio accumulation across a four-course sequence
...
This community toolkit is a simplified, portable version of the [Epistemic Stewardship Framework](https://github.com/nmadrid27/Epistemic-Stewardship-Framework-ESF-). The full ESF includes:
