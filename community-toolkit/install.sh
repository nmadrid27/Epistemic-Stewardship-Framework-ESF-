...
TOOLKIT_BASE="https://raw.githubusercontent.com/nmadrid27/Epistemic-Stewardship-Framework-ESF-/main/community-toolkit"
CYAN='\033[0;36m'
GREEN='\033[0;32m'
YELLOW='\033[1;33m'
RED='\033[0;31m'
...
curl -sSL "$TOOLKIT_BASE/templates/position-statement.md"      -o templates/position-statement.md
curl -sSL "$TOOLKIT_BASE/templates/record-of-resistance.md"    -o templates/record-of-resistance.md
curl -sSL "$TOOLKIT_BASE/templates/ai-use-log.md"              -o templates/ai-use-log.md
curl -sSL "$TOOLKIT_BASE/templates/five-questions-checklist.md" -o templates/five-questions-checklist.md
curl -sSL "$TOOLKIT_BASE/templates/disclosure-statement.md"    -o templates/disclosure-statement.md

# Download prompt
echo "  Fetching companion prompt..."
curl -sSL "$TOOLKIT_BASE/prompts/esf-companion.md" -o prompts/esf-companion.md

# Download Claude Code configuration
echo "  Fetching Claude Code configuration..."
curl -sSL "$TOOLKIT_BASE/.claude/agents/esf-companion.md"   -o .claude/agents/esf-companion.md
curl -sSL "$TOOLKIT_BASE/.claude/reference/esf-guide.md"    -o .claude/reference/esf-guide.md
