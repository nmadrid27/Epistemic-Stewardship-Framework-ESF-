---
title: "ESF Project Integrity Report"
author: Nathan Madrid
date: 2026-02-24
type: integrity-report
document: "Epistemic Stewardship Framework (complete project)"
directive-memo-referenced: true
disclosure-level: scholarship
version: "1.1"
status: complete
epistemic-weight: high
tags: [esf, integrity-report, self-application]
---

# Integrity Report: Epistemic Stewardship Framework

**Document:** Epistemic Stewardship Framework (all primary deliverables, Phases 1–7)
**Date:** 2026-02-24
**Directive Memo referenced:** Yes: `framework/ESF-Directive-Memo.md`
**Disclosure level applied:** Scholarship
**Assessed against:** Framework Document, Literature Review, Novel Contributions, Comparison Matrix, Faculty Guide, Student Guide, Institutional Guide, Accreditation Crosswalk, Assessment Rubrics, Self-Application Evidence

---

## 1. Directive Memo Alignment

*The Directive Memo for this project established thesis, emphasis, de-emphasis, non-negotiables, voice, and pedagogical rationale before any AI-assisted drafting began.*
...
- [x] **Tool-specific guidance**: No tool names appear in framework documents. Institutional reference case clarified as one implementation example during Phase 3 gate. Tool-agnostic design rationale documented in Self-Application Evidence (Section: Design Rationale).
- [x] **Student policing**: Agency framing confirmed throughout student materials. Phase 4 gate interrogated this explicitly. "Three options when no" (revise, reduce, be transparent) confirms the framework does not halt or punish.
- [x] **Comprehensive literature review**: Framework Document uses citations purposefully; standalone Literature Review is Phase 2. No exhaustive coverage attempted in core document.
- [x] **Institutional policy detail**: Framework Document describes constructs. Policy details (rollout, crosswalk, rubrics) are confined to Phase 5 Institutional Guide, as planned.
- [x] **Institution-specific context**: The originating institution appears as one illustrative example. Phase 3 gate added explicit tool-agnostic statement to the multi-agent reference.
...
**Drift detected:** None at the strategic or architectural level. Three citation over-attributions found and corrected during gate reviews (Pasmala, Atchley, Degen). These are production errors, not drift from the Directive Memo's intellectual position.
...
- [x] Cross-document terminology consistent: construct names consistent across all files. Student-facing documents use "Position Statement" throughout (Phase 4 and 5 gate corrections). Faculty-facing documents use "Directive Memo" throughout.
- [x] BMAD references: active framework language uses ESF terminology. BMAD appears only in historical/contextual references (Directive Memo's Pedagogical Rationale, Comparison Matrix limitation note, production history). Appropriate.
- [x] Accreditation Crosswalk resolved: specific unverified standard numbers removed (Phase 5 gate, Option B). Thematic descriptions only. Limitations and Disclosure sections updated.
...
| Assessment design rationale | None (human only) | Rubric dimensions, engagement level criteria, and institutional maturity model reflect Nathan's assessment experience |
| Directive Memo | Documented tension | AI-drafted from existing BMAD source files; Nathan accepted without revision. See flagged items. |

---

## 4. The Five Questions

Applied to the ESF project as a whole:

| # | Question | Answer | Notes |
|---|----------|--------|-------|
| 1 | **Can I defend this?** | Yes | Nathan can explain every construct, architectural decision, and scholarly claim without referencing AI's reasoning. Constructs originate from his operational institutional practice. |
| 2 | **Is this mine?** | Yes | The arguments are Nathan's. The prose is substantially AI-drafted within those arguments. Strategic and architectural decisions are 100% human (see Self-Application Evidence ratio table). |
| 3 | **Did I verify?** | Yes (29/31) | Pre-publication Task A complete (2026-02-24). 7 citation errors corrected in both primary documents. Two documented exceptions: Stoyanov preprint confirmed but PDF access blocked; Luksha 2024 article unconfirmable. No fabrications found across all gate reviews and verification pass. |
| 4 | **Would I teach this?** | Yes | Nathan practices this methodology in his courses and has applied it to AI 180 and AI 201 syllabi this quarter. Both integrations represent real-world validation. |
| 5 | **Is the disclosure honest?** | Yes | Disclosure statements on all 16 primary deliverables. Self-Application Evidence makes the human-AI ratio explicit. The Directive Memo tension is documented, not concealed. |
...
*Epistemic Stewardship Framework: Project Integrity Report*
*Nathan Madrid*
