#!/usr/bin/env bash
# ESF Student Toolkit - Repository Setup
...
#   6. Runs the ESF Student Toolkit installer
...
echo ""
echo -e "${CYAN}ESF Student Toolkit - Repository Setup${NC}"
echo "──────────────────────────────────────────"
echo ""
...
echo ""
echo "──────────────────────────────────────────"
echo -e "${CYAN}Installing ESF Student Toolkit...${NC}"
echo ""

INSTALLER_URL="https://raw.githubusercontent.com/nmadrid27/Epistemic-Stewardship-Framework-ESF-/main/student-toolkit/install.sh"
