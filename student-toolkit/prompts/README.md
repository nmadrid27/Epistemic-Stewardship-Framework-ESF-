...
Open `student-companion.md` and fill in every `[PLACEHOLDER]` with your information. Save it in your project folder so the AI can find it.
...
**If you use Claude Code:** The AI reads your `student-companion.md` and `project-workflow.md` automatically from your toolkit folder. Just tell it what project you want to work on.

**If you use ChatGPT, Gemini, or another tool:** Paste your filled-in `student-companion.md` as your first message (or as a system prompt if your tool supports it). Then paste `project-workflow.md` as a second message.
