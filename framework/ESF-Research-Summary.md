...
tags: [esf, research, sources]
---

# ESF Research Summary

## How Research Was Sourced, Verified, and Integrated into the Framework

This is a living document. It tracks every scholarly source used in ESF: how each was found, what it contributes, where it appears in the framework, and what verification work remains. Update this document as new sources are added or existing ones are refined.

---

## Research Approach

### Practice First, Literature Second

ESF's constructs were built from the author's operational practice before any literature review was conducted. The research serves three purposes:

1. **Validation:** Confirming that the problems ESF addresses are real and documented in the field
2. **Grounding:** Connecting ESF's practitioner-built constructs to established scholarly concepts and vocabulary
3. **Positioning:** Identifying where ESF fills gaps that existing frameworks leave open

The research does *not* originate the framework's constructs. It validates and contextualizes them.

### How Sources Were Found

| Method | Sources Found | Notes |
|--------|--------------|-------|
| **Planning phase research** | 18 (Sources 1-7, 9, 12, 14, 16-18, 20, 22, 25, 27, 29-31) | Identified during framework planning. Verified against AI knowledge; exact bibliographic details flagged for pre-publication confirmation where needed. |
| **NotebookLM queries** | 10 (Sources 8, 10-11, 13, 15, 19, 21, 23-24, 28) | Discovered through querying Google NotebookLM research notebooks during the two-level architecture integration. Source-grounded answers from uploaded documents. |
| **Direct knowledge** | 3 (Sources 4, 6, 9) | Foundational sources the author knew directly (Bloom, Brown, EU AI Act). |

### Verification Standards

Every source carries an epistemic marker:

| Marker | Meaning | Count |
|--------|---------|-------|
| **Confirmed** | The author knows this source directly or has independently verified its existence and claims | 9 |
| **Plan-verified** | Verified during planning phase; exact bibliographic details should be confirmed before publication | 9 |
| **NotebookLM-sourced** | Discovered through AI-mediated research; existence and claims verified through NotebookLM's source-grounded responses | 10 |
| **[PREPRINT]** | Not yet peer-reviewed; marked explicitly wherever cited | 3 |

**Zero tolerance for hallucinated citations.** Any source that cannot be verified is removed, not retained with a caveat.

---

## Sources by Concept Cluster

### Cluster 1: Epistemic Agency (4 sources)
...
### Cluster 2: Human Oversight and Metacognition (4 sources)

Establishes that human oversight of AI is harder than it looks, degrades over time, and requires structural intervention.
...
### Cluster 3: Content Stakes and Calibration (2 sources)

Supports the Content Epistemic Weight model: not all content demands the same level of human authority.
...
### Cluster 4: Transparency and Disclosure (3 sources)

Grounds the Disclosure Protocol and its distinction between compliance transparency and epistemic transparency.
...
### Cluster 5: Cognitive Load and Partnership (1 source)

Addresses the educational paradox: reducing cognitive load may reduce learning.
...
### Cluster 6: Iterative Methodology (4 sources)

Grounds the phased workflow model and the Framework Evolution Protocol.
...
### Cluster 7: Student AI Literacy (3 sources)

Reframes AI literacy from technical competency to epistemic practice.
...
**Integration pattern:** Allen & Kendeou and Kassorla establish the literacy field ESF complements. Luckin's empowerment/substitution distinction is ESF's orienting question: the framework is designed to ensure AI empowers rather than substitutes.

---

### Cluster 8: Scaffolded Student Engagement and Socratic AI (10 sources)

Added in v2.0 to support the two-level architecture and human-first sequencing. The newest cluster, sourced primarily through NotebookLM research queries.
...
**Integration pattern:** This cluster converges on three principles that define Level 2: (1) human-first sequencing (Hutson, Washington OSPI, Pasmala), (2) Socratic gates that develop reasoning rather than enforce compliance (Naeem, Favero, Degen & Asanov), and (3) process artifacts that make engagement visible and assessable (Plate & Hutson, Stoyanov, Lei). These three principles were already built into the author's practice; the cluster provides the scholarly validation.

---

## Cross-Cluster Integration Map

How sources connect across clusters to support ESF's core arguments:

| ESF Argument | Primary Sources | Supporting Sources |
|-------------|----------------|-------------------|
| **Epistemic agency requires structural support** | Clark & Chalmers (1998), Wu et al. (2025) | Tankelevitch et al. (2024), Atchley et al. (2024), Hutson (2025) |
| **"Review your work" is insufficient** | Tankelevitch et al. (2024), Atchley et al. (2024) | Bearman et al. (2024), Degen & Asanov (2025) |
| **Content type determines human involvement** | Bloom et al. (1956), Perkins et al. (2024) | Sweller (1988) |
| **Disclosure must be anchored to pre-drafting intent** | Weaver (2024), Clark & Chalmers (1998) | UNESCO (2023), OECD (2023) |
| **Iterative workflows need epistemic gates** | Brown (2008), Torrance (2019) | Luksha et al. (2024), Tankelevitch et al. (2024) |
...
| Gap | What Would Help | Priority |
|-----|----------------|----------|
| **Empirical validation of Directive Memo effectiveness** | Studies showing that pre-drafting intellectual authority documents improve output quality or ownership retention | High (for publication) |
| **Cross-cultural applicability** | Research on epistemic stewardship in non-Western educational contexts | Medium (for international adoption) |
| **Longitudinal effects of structured AI engagement** | Studies tracking student epistemic development over multiple terms with/without scaffolded AI frameworks | High (for Level 2 validation) |
| **Institutional adoption barriers** | Research on why faculty resist or adopt AI methodologies at scale | Medium (for Institutional Guide) |
| **Discipline-specific epistemic weight** | Research on whether content epistemic weight varies meaningfully across disciplines or holds universal | Low (current claim is universality; challenge would strengthen) |
