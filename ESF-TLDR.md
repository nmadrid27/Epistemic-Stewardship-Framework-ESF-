...
ESF is a structured method for making sure that work produced with AI assistance genuinely belongs to the person responsible for it, intellectually, not just administratively.

---

## The Problem

Universities have AI policies that say *whether* AI can be used. Nobody has a method for *how* to use it without losing intellectual ownership of the work.

Three specific failures:

1. **Ban-or-permit policies** regulate access but do not structure practice
2. **Student-only focus** ignores that faculty use AI too, often without any method for their own work
...
When a faculty member uses Level 1 to design an assignment, they are simultaneously designing the learning environment students work within at Level 2. Faculty who require intellectual discipline from students are practicing it themselves.
...
ESF does not recommend, require, or assume any specific AI tool. This is a design decision, not an oversight. The core problem (maintaining intellectual ownership when AI assists in producing work) occurs with every generative AI system. Metacognitive failures happen regardless of which tool you use (Tankelevitch et al., 2024). Tool-specific frameworks become obsolete when the tool changes. Writing a clear Directive Memo, detecting drift, verifying claims, and disclosing honestly are durable skills that transfer across any tool, model generation, and discipline.

The question is never "which AI did you use?" The question is "can you defend this as yours?"

For the full argument, see the Self-Application Evidence document.
...
- **Not a replacement** for existing frameworks. ESF works alongside the AI Assessment Scale (AIAS), AI Disclosure framework (AID), and institutional policies.
