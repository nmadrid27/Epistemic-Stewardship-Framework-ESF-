...
tags: [esf, student-guide, implementation]
---
...
The question is whether the work you produce with AI is actually yours. Does it reflect your thinking, your judgment, and your developing expertise? Or is it something you accepted because it sounded good enough to submit?
...
The Position Statement should take 5 to 10 minutes. Those minutes are where the learning happens. If you find you cannot write it, that is the most valuable information the exercise can produce. It means you do not yet know your position or have not read enough to form one. Go back to Inquire.
...
**What you are learning:**
- How to classify the intellectual demands of your own work
...
**What it looks like:** You are a full epistemic steward. You can run the five-phase process across complex, high-stakes projects. You can design gates for your own work and for others'. You can defend your work, articulate your method, teach your approach, and critically evaluate AI-assisted work (your own and others').

**What makes this level different:** At Level 4, you go beyond following a method. You are evaluating, adapting, and contributing to it. The shift from "using the framework" to "critiquing the framework" is the marker of genuine intellectual independence.
...
| 3 | Independent Use | Self-assessed gates with peer review | Can explain method to a peer, produce evaluable process record |
...
Your institution defines what is and is not permitted. Your instructor may set additional parameters for specific assignments. ESF provides you with the method to work *within* whatever boundaries apply, and to do so in a way that serves your learning rather than just your compliance.
