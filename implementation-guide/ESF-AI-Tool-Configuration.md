...
Persistent role-specific configurations for sustained project work. Agents carry domain context (institutional role, scholarly standards, audience awareness) and specify how ESF applies to their domain.
...
|-----------|----------------|-------|
| `curriculum-dev` skill | **Full** | Complete ESF workflow. Phase 3 (Directive Memo) is explicitly human-only with behavioral enforcement: "Do NOT offer to write the memo." Has Ownership Test, Five Questions, Role Distribution, Anti-Patterns, and gate cadence. |
...
| `capture` skill | **Appropriate exemption** | Quick-intake function. No intellectual stakes warrant ESF protocol. Correctly omits gates. |
...
- Remove or replace vault-specific references
...
[Agent persona: your institutional role, authority level, and the constituent
context you navigate.]
...
Maintain awareness of multiple constituent perspectives: student welfare,
...
who want stronger enforcement should embed the Five Questions and gate
behavior directly:
...
Engage with relevant scholarship using appropriate methods language.
...
methods limitations, and competing interpretations rather than
...
- AI must not originate: Analytical arguments, interpretive claims, theoretical
  positions, research methods decisions, data analysis conclusions
...
stronger enforcement, embed them directly in the agent instructions.
...
- Institutional context (role, courses, programs, institutional context)
